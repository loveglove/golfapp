...
<!-- 
                    ...
                    <h4>First time here? Get registered now!</h4>
                    <a href="/register" class="form-group"><button type="submit" class="btn btn-info block full-width m-b dim"><i class="fa fa-envelope"></i>  Register</button></a>
