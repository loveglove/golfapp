...
<!--                     <div>
                    ...
                    <form method="POST" action="{{ route('password.email') }}">
	                    ...
	                    <p class="m-b-30">We will send you an reset link to the email provided below</p>
	                    ...
	                    <button type="submit" class="btn btn-primary block full-width m-b dim">Send Password Reset Link</button>
	                </form>

                    <a href="/" class="form-group btn btn-link">Back to Home</a>
    ...
    <script>
        ...
        // });
            ...
            <div class="l-block" id="l-forget-password">
                <div class="lb-header palette-Red bg logo-header-auth">
                ...
                <div class="lb-body">
                    ...
                    <button type="submit" class="btn palette-Red bg">Send Password Reset Link</button>
                </form>

                    <div class="m-t-30">
                        <a data-block="#l-login" data-bg="red" class="palette-Red text d-block m-b-5" href="">Already have an account?</a>
                        <a data-block="#l-register" data-bg="red" href="" class="palette-Red text">Create an account</a>
                    </div>
                </div>
            </div>